      ...
      <section className="pb-24">
        <div className="container-page grid gap-12 md:grid-cols-2 md:items-start">
          <div className="space-y-5 text-sm leading-relaxed text-muted">
            ...
            <p>
              Based in Hyderabad, India, Konvexa is currently building four
              ventures: a web security platform, a QA automation tool, a smart
              expense tracker, and a clothing brand. Different markets, different
              users — same level of care in what gets shipped.
            </p>
            <p>
      ...
      <section className="border-t border-border/50 py-20">
        <div className="container-page flex flex-col items-center text-center">
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-3">
            ...
            <a href="https://github.com/KonvexaHQ" target="_blank" rel="noopener noreferrer" className="btn-ghost">
              GitHub
            </a>
          </div>
        </div>
